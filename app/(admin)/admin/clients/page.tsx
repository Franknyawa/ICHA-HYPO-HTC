  ...
  return (
    <main>
      ...
      <div className="space-y-6 p-4 md:p-6">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 dark:text-slate-500">{c.pointVenteNom}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 text-right">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 dark:text-slate-500">{c.nbVentes} ventes</p>
                    </div>
                  </div>
                </div>
              ))}
        ...
        {groupes.length === 0 && (
          <p className="text-sm text-slate-400 dark:text-slate-500">Aucun client enregistré.</p>
        )}
      </div>
    </main>
  );
